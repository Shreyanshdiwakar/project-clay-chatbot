  ...
  return (
    <div className={isCompact ? "" : "mb-4"}>
      ...
      <button
        ...
        className={`flex items-center ${isCompact ? 'space-x-0' : 'space-x-2'} bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg ${isCompact ? 'px-2 py-1' : 'px-4 py-2'} text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors`}
        type="button"
